...
def figure_case_study_epigenomics_heatmap(
    ...
    # Step2
    considered_signatures = signatures
    considered_dna_elements = all_dna_elements
...
def main():
    ...
    if epigenomics_heatmap:
        ...
        # We need the signatures list although it has the same entries
        # Index walks through each list below
        # For Index=1 -> 'SBS4' -> ('SBS4', SBS), -> ('SBS4', 'Lung-AdenoCA') -> ('SBS4 Lung-AdenoCA')
        signatures = ['SBS4',
                      'SBS4',
                      'SBS4',
                      'SBS4',
        ...
        signature_tissue_type_tuples = [('SBS4', None),
                                        ('SBS4', 'Lung-AdenoCA'),
                                        ('SBS4', 'Lung-SCC'),
                                        ('SBS4', 'Head-SCC'),
                                        ('SBS4', 'Liver-HCC'),
        ...
        signatures_ylabels_on_the_heatmap = [('SBS4 (n=5)'),
                                             ('SBS4 Lung-AdenoCA'),
                                             ('SBS4 Lung-SCC'),
                                             ('SBS4 Head-SCC'),
                                             ('SBS4 Liver-HCC'),
